...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1291, 716)
        self.graphicsView_2 = QtWidgets.QGraphicsView(Form)
        self.graphicsView_2.setGeometry(QtCore.QRect(5, 30, 608, 608))
        ...
        self.navigate_button.setGeometry(QtCore.QRect(380, 670, 231, 31))
        self.navigate_button.setObjectName("navigate_button")
        self.camera_slider = QtWidgets.QSlider(Form)
        self.camera_slider.setGeometry(QtCore.QRect(10, 680, 351, 16))
        ...
        self.graphicsView.setGeometry(QtCore.QRect(640, 30, 640, 480))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "camera angle"))
        self.label_2.setText(_translate("Form", "MAP"))
        self.navigate_button.setText(_translate("Form", "navigate to the nearest object"))
        self.camera_image.setText(_translate("Form", "YOLOV5"))
