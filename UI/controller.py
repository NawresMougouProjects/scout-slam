...
class GUI(QDialog):
    ...
    def __init__(self,parent=None):
        ...
        self.base_map_dir = os.environ['HOME'] + "/yolo_nav/src/navigation_params/map/yolo_nav_map.pgm"
        yaml_path = os.environ['HOME'] + "/yolo_nav/src/navigation_params/map/yolo_nav_map.yaml"
...
if __name__ == '__main__':
    ...
    rospy.Subscriber("/camera/depth/image_raw", Image, callback_depth_img)
    window.show()
    sys.exit(app.exec_())
